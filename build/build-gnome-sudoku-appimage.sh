...
# C. Vala code fixes (The God-Mode Edition)
...
find . -name "*.vala" -exec sed -i 's/dispose_template/unref/g' {} +
find . -name "*.vala" -exec sed -i 's/\.present\s*(window)/.present()/g' {} +
...
find . -name "*.vala" -exec sed -i 's/new Adw.MessageDialog\s*(win_str, null)/new Adw.MessageDialog(null, win_str, null)/g' {} +
find . -name "*.vala" -exec sed -i 's/new Adw.MessageDialog\s*(_("The puzzle you have entered is not a valid Sudoku."), _("Please enter a valid puzzle."))/new Adw.MessageDialog(null, _("Error"), _("Invalid Puzzle"))/g' {} +
find . -name "*.vala" -exec sed -i 's/new Adw.MessageDialog\s*(_("The puzzle you have entered has multiple solutions."), _("Valid Sudoku puzzles have exactly one solution."))/new Adw.MessageDialog(null, _("Error"), _("Multiple Solutions"))/g' {} +
find . -name "*.vala" -exec sed -i 's/new Adw.AboutDialog.from_appdata/new Adw.MessageDialog/g' {} +

# Fix SpinRow to ActionRow accessor mismatch
find . -name "*.vala" -exec sed -i 's/n_puzzles.get_adjustment ()/((SpinButton)n_puzzles.get_suffix ()).get_adjustment ()/g' || true
