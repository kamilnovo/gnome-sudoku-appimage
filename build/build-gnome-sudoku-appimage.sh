...
# 3. Build Json-Glib
download_extract "https://download.gnome.org/sources/json-glib/1.10/json-glib-1.10.6.tar.xz" "json-glib"
cd json-glib
...
./linuxdeploy --appdir "$APPDIR" \
    ...
    --library "$LOCAL_PREFIX/lib/x86_64-linux-gnu/libjson-glib-1.0.so.0"
